...
int main()
{
    ...
    printf("Enter the private key for Mamtha (a): ");
    scanf("%lld", &a);
    x = mod_exp(G, a, P); 


    printf("Enter the private key for logesh (b): ");
    scanf("%lld", &b);
    y = mod_exp(G, b, P);
...
## Output:
![image](https://github.com/user-attachments/assets/b948f116-f66b-4964-b29b-44f5d515c975)
